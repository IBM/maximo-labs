...
1. Goto dashboard tab and select `Add dashboard` to configure new dashboard.</br></br>
![Navigate to Asset Dashboard](img/create_dashboard_01.png)</br></br>

2. Select `Time series line` card type.</br></br>
![Add timeseries card](img/create_dashboard_02.png)</br></br>

3. Click `Add Hierarchy Data Item` button.</br></br>
![Add Hierarchy Data Item](img/create_dashboard_03.png)</br></br>

4. In the **Add Hierarchy Data Items** dialog, you will see all child resources (devices) assigned to the current asset. Select the child devices whose metrics you want to display on the chart. You can select multiple devices to compare their data. Click `Next` to proceed to data item selection.</br></br>
![Select Child Resources](img/create_dashboard_04.png)</br></br>

5. In the next step, you will see all available data items (metrics) from the selected child devices. Select the data items you want to visualize on the chart. eg. We have selected pressure from 2 different device to compare with each other. You can select the same metric from multiple devices to compare them, or select different metrics. Click `Submit` to add the data items to the card.</br></br>
![Select Data Items](img/create_dashboard_05.png)</br></br>

6. The card will display the selected metrics from child devices. We can also add dataitems from asset asusal if KPI created at asset.</br></br>
![Configure Card](img/create_dashboard_06.png)</br></br>

7. Select `edit` button child metrics to add aggregation functions and time grain.</br></br>
![Edit Metrics](img/create_dashboard_07.png)</br></br>
![Configure Card](img/create_dashboard_08.png)</br></br>

8. Save and The Time series line card now displays data from multiple child devices on a single chart. You can compare trends and patterns of metrices across different devices easily.</br></br>
