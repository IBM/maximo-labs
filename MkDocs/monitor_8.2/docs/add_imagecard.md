...
![Munich Occupancy Image Card](/img/monitor_8.2/im1.png) &nbsp;

**Here is what you see when you click on one of the hotspots.**

![Munich Occupancy Hotspot](/img/monitor_8.2/im2.png) &nbsp;
...
![Grab API Key and Token](/img/monitor_8.2/im6.png) &nbsp;
...
![Create POST Request](/img/monitor_8.2/im8.png) &nbsp;
...
![URL Geo Code](/img/monitor_8.2/im9.png) &nbsp;
![URL TenantID](/img/monitor_8.2/im10.png) &nbsp;
...
![Header Info](/img/monitor_8.2/im11.png) &nbsp;
![Header in Postman](/img/monitor_8.2/im12.png) &nbsp;

5. Now, navigate to the `Body` tab and the select `form-data` radio button.

![Body and Form Data Postman](/img/monitor_8.2/im13.png) &nbsp;
...
![KC Form Data Requirements](/img/monitor_8.2/im14.png) &nbsp;
![File Drop Down](/img/monitor_8.2/im15.png) &nbsp;
![Complete Form Data](/img/monitor_8.2/im16.png) &nbsp;
...
![Success](/img/monitor_8.2/im17.png) &nbsp;
...
![Sourdough Leavening Dashboard](/img/monitor_8.2/im28.png) &nbsp;
...
![Gear Edit](/img/monitor_8.2/im21.png) &nbsp;
3. Click `Edit Dashboard`.
![Edit Dashboard](/img/monitor_8.2/im22.png) &nbsp;
...
![Card Array](/img/monitor_8.2/im19.png) &nbsp;
``` yaml
{
...
![JSON Mapping 1](/img/monitor_8.2/im25.png) &nbsp;
![JSON Mapping 2](/img/monitor_8.2/im26.png) &nbsp;
