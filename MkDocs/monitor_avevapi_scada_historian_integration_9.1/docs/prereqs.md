...
2.  User access to a Maximo Application Suite environment that can configure Aveva PI Historian integration in Monitor. This require:</br>
...
Docker/Podman must be installed on your local machine or Aveva PI Scada Server.</br>
There are different ways to install the Docker/Podman engine depending on the package and the OS.</br>
