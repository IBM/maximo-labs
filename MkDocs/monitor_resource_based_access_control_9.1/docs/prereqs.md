...
Here are the pre-requisites for working with **Resource-Based Access Control** in Maximo Monitor 9.1.

!!! attention
    This lab requires **Maximo Monitor version 9.1 or later**  and valid access to the **Monitor Setup and Security Modules**.

---

# All Exercises

All exercises in the Resource-Based Access Control module require that you have:
...
4. Resource-Based Access Control configuration access:  
   - Ability to access **Suite > Security > Security Groups**  
   - Ability to access **Suite > Security > Users**
   - Ability to configure **Data Restrictions** in Security Groups

5. Existing resources in your Monitor environment:
    - Assets, Locations, Systems, Organizations, Sites, or Device Types
    - These will be used to test data restriction functionality
...
- You have existing resources (Assets, Locations, etc.) to test with
