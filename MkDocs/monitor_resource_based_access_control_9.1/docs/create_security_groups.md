...
2. Enter a name for the group, e.g., `MONITOR_DATA_RESTRICTION` and Click **Create group** </br>
...
2. Select the features/modules that this group should have access to  
   Example:  
   – Enable Dashboard access  
   – Enable CRUD operations on Dashboard  
   – Disable Setup page access
3. Save the group once permissions are configured
