...
![navigate_to_health](../../../apm_8.11/img/hpu_8.11/assets_grid_page.png)	
...
![navigate_to_health](../../../apm_8.11/img/hpu_8.11/assets_grid_page_hamburger.png)
...
![saved_views](../../../apm_8.11/img/hpu_8.11/savedviews.png) 
...
![select_views](../../../apm_8.11/img/hpu_8.11/substationtransformerview.png) 
...
![show_all_assets](../../../apm_8.9/img/apm_8.9/show_all_assets.png)
2. Click the `filter` icon that looks like a funnel. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 33.png)
3. Select the `pencil` symbol for containers
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 34.png)
4. Select  `NIXON9098`
5. Click `OK`
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 35.png)
6. Click `Apply`

![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 36.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 37.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 38.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 39.png)
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 40.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 41.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 42.png)
...
![setu_ assets](../../../apm_8.9/img/HPU_8.9/HPU 43.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 74.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 75.png)
2. Click on the `Actions` drop down selection box button to see the available options.
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 76.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 77.png)
3. Click the `funnel` symbol
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 78.png)
4. Select the `pencil` symbol for `Query`
![setup_assets](../../../apm_8.11/img/hpu_8.11/edit_query_filter.png)
5. Select `ST_EUDEMO_A` from the list
6. Click `OK`
![st_eudemo_a](../../../apm_8.11/img/hpu_8.11/st_eudemo_a.png)
7. Click `Apply`
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 81.png)
8. Select the 3rd icon in the upper right of the screen to see the selected assets on a `Charts` view
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 82.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 83.png)
2. Return to the charts page by using the breadcrumb at the top of the page. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 84.png)
...
![set_matrix_version](../../../apm_8.11/img/hpu_8.11/set_matrix_version.png)
9. Click `Assets` breadcrumb to navigate back to the `Matrix` view.
![view_matrix](../../../apm_8.11/img/hpu_8.11/asset_drill_in_view.png)
...
![final_matrix](../../../apm_8.11/img/hpu_8.11/final_matrix.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 85.png)
3. Select `Failing Before PM` work queue
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 86.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 87.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 88.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 89.png)
...
![setup_assets](../../../apm_8.11/img/hpu_8.11/chevron.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 90.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 91.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 92.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 93.png)
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 94.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 95.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 96.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 29.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 44.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 104.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 55.png)
3. From the `Projects` tab, click on `ST Investment Project`
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 105.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 106.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 107.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 108.png)
2. From the pop-up, click all three scenarios
3. Click `Compare`
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 109.png)
4. Review the output noting the results of each strategy
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 110.png)
