...
![assets_page](../../../apm_8.11/img/hpu_8.11/search_health_group.png)
4. Click the `Applications` tab.
5. Select `Assets`
![assets_page](../../../apm_8.11/img/hpu_8.11/click_applications_assets.png)
6. Click the `Grant listed options for the application` 
7. Enable options for asset actions
![assets_page](../../../apm_8.11/img/hpu_8.11/turn_on_options.png)
8. Click `Save Group`. 
![assets_page](../../../apm_8.11/img/hpu_8.11/confirmation_save.png)
...
![assets_page](../../../apm_8.11/img/hpu_8.11/assets_grid_page.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 3.png)	

2. Select the `Scoring and DGA settings` section on the left nav bar
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 4.png)	
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 5.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 6.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 9.png)
2. When prompted, scroll and select the `EUORG1_EUDEMO_ST`
3. Click `Apply`
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 10.png)
4. Click `Create`
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 11.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 15.png)
2. Select the `Score types` tab. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 18.png)
3. Click the `Create new score type` button. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 19.png)
...
3. Click `Save`. <br/>
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 20.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 16.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 22.png)
2. Select `Substation Efficiency` from the score options. 
3. Click `Done`. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 23.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 24.png)
2. From the `Add a contributor` popup, select the tile `FACAGESAMPLE`. 
3. Click `Add`. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 25.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 26.png)
2. In the popup, change the % weight to `100`. 
3. Click `Save`. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 27.png)
4. Change the `Active` button to `Yes`. <br/>
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 28.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 45.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 46.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 56.png)
4. On the `Plan templates` tab, click the `+` symbol to create a new plan template. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 57.png)
...
9. Click `Create`. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 58.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 51.png)
2. Select the `red` box in the matrix to show the table view of the assets. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 52.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 53.png)
5. Select `Create investment project`. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 54.png)
...
6. Click `Create`
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 59.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 60.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 61.png)
4. Select `Add to investment project`. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 62.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 63.png)
2. Click `Add`
3. From the `Edit project` page, click `Save`. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 64.png)
4. Click `Save` from the `Confirm save` popup. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 65.png)
...
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 66.png)
4. Click the `+` to create the first strategy. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 67.png)
5. From the popup, make sure the `Strategy` selection is `Maintain risk`, the click `Create`. 
![setup_assets](../../../apm_8.9/img/HPU_8.9/HPU 68.png)
