# Build MAS v8.9 Health and Predict - Utilities (HPU) Demo

Follow the steps in this lab in your own environment to create the necessary components to deliver the MAS v8.9 HPU Demo Script. The data for you system can be found here….

1. Create group using notebooks
2. Create score type
3. Create group using Custom Scoring Methodology
4. Create custom matrix
5. Plan replacement plan pemplate for Substation Transformers
...
Complete the form for the new custom score type.

The score type can be customized with new ranges, colors and icons.
...
Return to the "Groups" tab to set up the custom score methodology.
...
2. From the table view, select `50` from the pulldown at the bottom of the table
3. Select the `box` at the top of the page to select all of the assets on the table
...
Congratulations.  You now have create the MAS v8.9 Health and Predict - Utilities (HPU) lab ready for demo.
