...
![setup assets](img/p01.png) 

2. Click on `Configurations` and `Watson Studio`
![setup assets](img/p02.png) 
...
![setup assets](img/p05.png) 
 
2. Click 'New Project'. 
![New Project](img/p06.png) 

3. Accept default and click 'Next'. 
![Default Value](img/p07.png) 

4. Click 'New Empty Project'. 
![New Empty Project](img/p08.png)

5. Enter a project name and description.
![setup assets](img/p09.png) 

6. Click `Add to Project`.
![setup assets](img/p10.png) 
