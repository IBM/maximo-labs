...
![Click on App Switch](img/healthscoring_1.png)

2. Select `Health` application from the `menu` bar and you will view the assets list.
![Select "Health" application](img/healthscoring_2.png)
![Health assets page](img/healthscoring_3.png)
...
![Search icon](img/healthscoring_4.png)
![Search for pump](img/healthscoring_5.png)
...
![Save as](img/healthscoring_6.png)
![Sae as new view](img/healthscoring_7.png)
...
![View in single view](img/healthscoring_8.png)
 
5. Click on the `Column Selection` menu icon.
![Click column selection menu icon](img/healthscoring_9.png)
![Column selection view](img/healthscoring_10.png)

6. Click `Manage columns`.
![Click manage columns](img/healthscoring_11.png)

7. Type `manufacturer` in the search field and press enter key on your keyboard. 
![Type in search fields](img/healthscoring_12.png)
![Type "manufacturer"](img/healthscoring_13.png)

8. Select the check box for `manufacturer` and click `Ok`
![Check box](img/healthscoring_14.png)
 
9. Click on the `Column Selection` icon.
![Click on "Column selection"](img/healthscoring_15.png)

10. Check if you can see the added new field `Manufacturer` in your view.
 ![Check for "Manufacturer" column](img/healthscoring_16.png)
...
![Navigate to map view](img/healthscoring_17.png)
...
![Select pump](img/healthscoring_18.png)
 
3. Use the zoom in/out features to adjust your map view.
![Zoom in/out features](img/healthscoring_19.png)
![Adjust map view](img/healthscoring_20.png)
 
4. Click on `Actions` and choose the option `Add Flag`. 
![Add flag](img/healthscoring_21.png)

5. Select the Flag option `Replace` and click `Add Flag`. You will see the `Replace` tag added to the pump.
![Choose "Replace"](img/healthscoring_22.png)
![Click "add flag"](img/healthscoring_23.png)
![See `Replace` tag added](img/healthscoring_24.png)
...
![System message](img/healthscoring_25.png)
...
![Navigate to work queues](img/healthscoring_26.png)
...
![Assets that coudl fail before PM](img/healthscoring_27.png)

3.	Expand the column width of "Asset" to view the full asset names.
![Expand column width](img/healthscoring_28.png)
![Expand column width](img/healthscoring_29.png)
![List of pumps and their PM dates](img/healthscoring_30.png)
  
4.	View the list of pumps and their predicted failure dates. Check for the pump that has the lowest Health Score. 
![List of pumps with health scores](img/healthscoring_31.png)
...
![Select scoring](img/healthscoring_32.png)
...
!["Ranges" tab](img/healthscoring_33.png)
...
![Health score box](img/healthscoring_34.png)
![Health scoring page](img/healthscoring_35.png)
...
!["Scoring" bedcrumb](img/healthscoring_36.png)
![Main scoring page](img/healthscoring_37.png)

5. Select the `Contributors` tab so that we can explore what contributors are available to use when creating scores. 
![`Contributors` tab](img/healthscoring_38.png)
...
![Select contibutor](img/healthscoring_39.png)
![Contributor formula](img/healthscoring_40.png)
...
![`Scoring` breadcrumb](img/healthscoring_41.png)
![`Groups` tab](img/healthscoring_42.png)
...
![Create your own group](img/healthscoring_43.png)
...
![Select a group](img/healthscoring_44.png)
...
![Add first contributor](img/healthscoring_50.png)
...
![Add a contributor popup](img/healthscoring_51.png)
...
![Add a second contributor](img/healthscoring_52.png)
...
![Adjust contributor weight](img/healthscoring_63.png)

32. Return to your main score page by clicking `Scoring` in the breadcrumbs.
![Return to main score page](img/healthscoring_64.png)
...
![Successfully added new health score for pumps group](img/healthscoring_65.png)
...
![Work queues icon](img/healthscoring_66.png)

2.	Select `Failing before PM` from the queue names.
![Select from work queue list](img/healthscoring_67.png)

3.	Adjust the "Asset: column width to view the full asset names and click on `PMPDEVICE003`
![Adjust column width and click on asset](img/healthscoring_68.png)
![Asset details page](img/healthscoring_69.png)

4.	View pump `PMPDEVICE003` and click and view details under `Asset Health` section. 
![Asset health section](img/healthscoring_70.png)
...
![Health history section](img/healthscoring_71.png)
...
![Predictions section](img/healthscoring_72.png)
...
![Maximize trend card](img/healthscoring_73.png)

5. Close the maximized view by clicking on the close icon. 
![Close maximized view](img/healthscoring_74.png)
 
6. Scroll down to `Factors that contribute to failures` card and view the results or full analysis tree.
![View analysis tree for factors that contribute to failures](img/healthscoring_75.png)
...
![Predicted failure information](img/healthscoring_76.png)
...
![Create service request](img/healthscoring_77.png)
...
![Create service request](img/healthscoring_78.png)
...
![Navigate to scoring](img/healthscoring_84.png)

2.	Go to the group you have created and delete it.
![Delete scoring group](img/healthscoring_85.png)

3.	Check if you have selected the group you have created and click `Delete`.
![Confirm delete scoring group](img/healthscoring_86.png)
