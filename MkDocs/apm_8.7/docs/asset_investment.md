...
1. From the main grid view, click the filter icon.
![setup assets](/img/apm_8.7/AIO 3.png)

2. Then select `Type`.
![setup assets](/img/apm_8.7/AIO 4.png)

3. From the pop-up, find `Substation Transformers`, select it, and press `OK`.  It may be necessary to use the search capability or scroll.
![setup assets](/img/apm_8.7/AIO 5.png)

4. Finally, press `Apply`.
...
In this case, there are 13 substation transformers. You will action the assets below.
...
1. Select the above assets that appear on the resulting list and press `Create investment project`.  In this case, the first 3 appear on the list.
...
3. Select the remaining substation transformers, 
...
Creating investment strategies in an AIO Project:  `Maintain Risk`.  The first strategy, maintain risk, determines which assets need to be replaced, and when, in order to maintain the average risk of the project over the life of the project.  The average risk is the average of the individual assets in the project.
