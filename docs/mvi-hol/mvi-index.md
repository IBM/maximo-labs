...
<p>Maximo Visual Inspection coupled with <b>Maximo Visual Inspection Mobile</b>, a standalone iOS application that is designed to execute models built on the Maximo Visual Inspection platform, provide users with a comprehensive visual inspection solution.</p>
...
<p>During this lab you will learn how to prepare a dataset to be trained, train a model using a dataset, deploy a model and complete an inspection using Maximo Visual Inspection Mobile.</p>
