...
# Exercise Two - Maximo Visual Inspection Mobile
...
<br>
Before you begin, make sure you followed the steps in the [Prerequisites](prereqs.md) page pertaining to the app.
